...
const booksData = [
    ...
    { sl: 4, title: "Computer System Architecture", author: "M. Morris Mano", edition: "3e", dept: "CSE/IT" },
    { sl: 5, title: "Fundamentals of Computer Algorithms", author: "Ellis Horowitz", edition: "-", dept: "CSE/IT" },
    { sl: 6, title: "Computer Organization and Design", author: "David A. Patterson", edition: "4e", dept: "CSE/IT" },
    { sl: 7, title: "The Intel Microprocessors", author: "Barry B. Brey", edition: "8e", dept: "CSE/IT" },
    { sl: 8, title: "Data & Computer Communications", author: "William Stallings", edition: "7e", dept: "CSE/IT" },
    { sl: 9, title: "Computer Networks", author: "Tanenbaum", edition: "4e", dept: "CSE/IT" },
    { sl: 10, title: "Software Engineering: A Practitioner's Approach", author: "Roger S. Pressman", edition: "6e", dept: "CSE/IT" },
    { sl: 11, title: "Introduction to Automata Theory", author: "John E. Hopcroft", edition: "3e", dept: "CSE/IT" },
    { sl: 12, title: "Teach Yourself C++", author: "Herbert Schildt", edition: "3e", dept: "CSE/IT" },

    // PHARMACY BOOKS
    { sl: 1, title: "Cell and Molecular Biology", author: "E.D.P. De Robertis", edition: "4e", dept: "Pharmacy" },
    { sl: 2, title: "Clinical Pharmacy & Therapeutics", author: "Roger Walker", edition: "11e", dept: "Pharmacy" },
    { sl: 3, title: "Goodman & Gilmans The Pharma Basis of Therapeutics", author: "Alfred G. Goodman", edition: "13e", dept: "Pharmacy" },
    { sl: 4, title: "Organic Chemistry", author: "Robert Morrison", edition: "9e", dept: "Pharmacy" },
    { sl: 5, title: "Ansels Pharmaceutical Dosage Forms", author: "Loyd V. Allen", edition: "3e", dept: "Pharmacy" },
    { sl: 6, title: "Basic and Clinical Pharmacology", author: "Bertram G. Katzung", edition: "5e", dept: "Pharmacy" },
    { sl: 7, title: "Robbins & Cotran Pathological Basis of Disease", author: "Vinoy Kumar", edition: "-", dept: "Pharmacy" },
    { sl: 8, title: "Comprehensive Pharmacy Review", author: "Leon Shargel", edition: "8e", dept: "Pharmacy" },
    { sl: 9, title: "Microbiology", author: "Michael Pelczar", edition: "9e", dept: "Pharmacy" },
    { sl: 10, title: "Physical Pharmacy", author: "Alfred Martin", edition: "2e", dept: "Pharmacy" }
];
